                ...
                <div class="card-body">
                    <form name="form_q" onsubmit="sendData(); return false;">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="q_cate" name="q_cate"
                                value="<?= $row['q_cate'] ?>" />
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" id="q_seq" name="q_seq"
                                value="<?= $row['q_seq'] ?>" />
                            <div class="form-text"></div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="q_des" class="mb-2">問題</label>
                            <textarea name="q_des" id="q_des" class="form-control" cols="30"
                                rows="2"><?= $row['q_des'] ?></textarea>
                            <div class="form-text"></div>
                        </div>
