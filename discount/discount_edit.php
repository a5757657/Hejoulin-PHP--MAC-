                ...
                <div class="card-body">
                    <form name="form1" onsubmit="sendData(); return false;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0.00" max="100.00" step="0.01" class="form-control" id="perscent"
                                name="perscent" value="<?=$row['perscent']?>">
                            <div class="form-text"></div>
                        </div>
